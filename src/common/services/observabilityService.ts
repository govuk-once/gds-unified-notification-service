...
export const MetricsLabels = {
  ...
  GROUP_PROCESSING_DURATION_PER_MESSAGE: 'GROUP_PROCESSING_DURATION_PER_MESSAGE',
  ...
  MTLS_AUTH_REQUESTS_DENIED_NO_ORGANIZATION_COUNT: 'MTLS_AUTH_REQUESTS_DENIED_NO_ORGANIZATION_COUNT',
  ...
  QUEUE_GROUP_PROCESSING_PUBLISHED_SUCCESSFULLY: 'QUEUE_GROUP_PROCESSING_PUBLISHED_SUCCESSFULLY',
  QUEUE_GROUP_PROCESSING_PUBLISHED_FAILED: 'QUEUE_GROUP_PROCESSING_PUBLISHED_FAILED',
...
export const MetricsLabelsUnits = {
  ...
  [MetricsLabels.GROUP_PROCESSING_DURATION_PER_MESSAGE]: MetricUnit.Milliseconds,
  ...
  [MetricsLabels.MTLS_AUTH_REQUESTS_DENIED_NO_ORGANIZATION_COUNT]: MetricUnit.Count,
...
export class ObservabilityService {
  ...
  public recordHttpErrorResponse(statusCode: number, functionName?: string) {
    ...
    const label =
      statusCode >= 500 ? MetricsLabels.API_SERVER_ERROR_RESPONSES : MetricsLabels.API_CLIENT_ERROR_RESPONSES;
