...
- Terraform conventions:
  ...
  - Use modules only for re-useable resources, if the resource is to be used for a singular use case - it should be placed into the root `infrastructure/terraform` directory
